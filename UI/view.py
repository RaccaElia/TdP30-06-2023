...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddmethod = ft.Dropdown(label="Squadra")
        self._txtSoglia = ft.TextField(label="Tifosi")
        ...
        row2 = ft.Row([self.btn_graph, self.btn_dettagli, self.btn_search], alignment=ft.MainAxisAlignment.CENTER)
